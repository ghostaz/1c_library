...
Функция СоздатьКнигу(Наименование, ПолноеНаименование, Описание, Авторы, Издательство, Страниц, ГодИздания, ИнвентарныйНомер, ISBN, ББК, Штрихкод, ФайлОбложки) Экспорт
	...
	Исключение
		...
		СообщениеПользователю.Текст = "Не удалось создать книгу";
		СообщениеПользователю.Сообщить();
		ОбщегоНазначения.ЗафиксироватьОшибку(СообщениеПользователю.Текст, ОписаниеОшибки, Метаданные.Справочники.Книги, Наименование);
	КонецПопытки;
...
// 
// Параметры:
// 	ГруппаКниг - СправочникСсылка.Книги - Группа книг в которой проиходится поиск книг
// Возвращаемое значение:
