...
Процедура ПроверитьРасширениеРаботыСФайламиЗавершение(Подключено, ДополнительныеПараметры) Экспорт
	...
	ИначеЕсли ДополнительныеПараметры.ОписаниеОповещения <> Неопределено Тогда // Если вдруг просто надо продключить расширение без перехода куда либо
...
Процедура ЗагрузитьФайл(ПроцедураДляВозвратаНаФорму, УникальныйИдентификаторФормы) Экспорт
