...
Процедура ПеренестиФайл(Файл, МестоНазначения) Экспорт
	...
	Если МестоНазначения = Перечисления.МестаХраненияФайлов.ЛокальныйДиск Тогда 
		...
		Исключение
			...
			ОбщегоНазначения.ЗафиксироватьОшибку("Произошла ошибка при переносе файла на локальный диск.", ОписаниеОшибки, Метаданные.Справочники.Файлы, Файл);
			Возврат;
		КонецПопытки;
	...
	Иначе
		...
		Исключение
			ОписаниеОшибки = ОписаниеОшибки();
			ОбщегоНазначения.ЗафиксироватьОшибку("Произошла ошибка при переносе файла в информационную базу.", ОписаниеОшибки, Метаданные.Справочники.Файлы, Файл);
			Возврат;
		КонецПопытки;
...
Функция СоздатьФайлНаДиске(КороткоеИмяФайла, ДанныеФайла, ИдентификаторФайла) Экспорт
	...
	Исключение 
		ОписаниеОшибки = ОписаниеОшибки();
		ОбщегоНазначения.ЗафиксироватьОшибку("Произошла ошибка при сохранении файла на диске.", ОписаниеОшибки, Метаданные.Справочники.Файлы);
